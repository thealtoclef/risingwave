...
use risingwave_common::catalog::{
    ...
    Engine, ICEBERG_SINK_PREFIX, ICEBERG_SOURCE_PREFIX, TableId, ObjectId,
};
...
use risingwave_connector::{
    WithOptionsSecResolved, WithPropertiesExt, source,
};
...
use risingwave_sqlparser::ast::{
    CdcTableInfo, ColumnDef, ColumnOption, CompatibleFormatEncode, CreateSink,
...
pub async fn create_iceberg_engine_table(
    ...
    let sink_iceberg_options = iceberg_engine::build_iceberg_sink_with_options(
        iceberg_engine::BuildSinkOptionsCtx {
