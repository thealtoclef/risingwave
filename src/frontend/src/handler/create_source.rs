...
use risingwave_connector::source::cdc::{
    ...
    CDC_SNAPSHOT_CATCHUP_TIMEOUT_KEY, CDC_SNAPSHOT_DEDICATED_KEY, CDC_SNAPSHOT_HOSTNAME_KEY,
    CDC_SNAPSHOT_MODE_KEY, CDC_SNAPSHOT_PASSWORD_KEY, CDC_SNAPSHOT_PORT_KEY,
    CDC_SNAPSHOT_USERNAME_KEY, CDC_TRANSACTIONAL_KEY, CDC_WAIT_FOR_STREAMING_START_TIMEOUT,
...
pub fn bind_connector_props(
    ...
    if is_create_source && create_cdc_source_job {
        ...
        // Only inject Debezium-specific properties for Debezium-based CDC connectors.
        if with_properties.is_debezium_cdc_connector() {
